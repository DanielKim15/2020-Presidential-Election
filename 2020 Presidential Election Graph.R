...
#election dataset
election2020 <- read_csv("/Users/dannykim/Desktop/USElection2020-NYT-Results-master/data/2020-11-16 00-41-31/presidential/presidential.csv", na=c(" ","NA","NULL","PrivacySuppressed"))
...
electoral_number <- read.csv("/Users/dannykim/Desktop/STAT 4365 R and Python Notes:HW:HW solutions/Final Project/electoralvotes (2).csv")
...
plot_election_results(electoral = F, vote_type = "total", region = c("Georgia","Florida","Alabama")) 
plot_election_results(electoral = F, vote_type = "total", region = c()) 
plot_election_results(electoral = T, vote_type = "total", region = c()) 
